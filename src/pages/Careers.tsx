        ...
        <div className="container mx-auto max-w-3xl">
          <GlassCard className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              This is a demonstration SaaS project. Hiring is not currently active. 
              This page illustrates how a careers section would be structured in a production application.
            </p>
            <div className="p-4 glass rounded-lg text-left max-w-md mx-auto mb-8">
              <p className="font-medium mb-2">In a production environment, this would include:</p>
